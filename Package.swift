...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libkivy",
            url: "https://github.com/kv-swift/KivyCore/releases/download/311.1.20/libkivy.zip",
            checksum: "cf52bf4771145ce599ab4a33cff9c76b019536b8936889aa48ccb2c36e695e35"
        )
    ]
)
