...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libkivy",
            url: "https://github.com/kivyswiftlink/KivyCore/releases/download/311.1.5/libkivy.zip",
            checksum: "910eaf3a01c876710353aa598f10ef13b5f893103e35701a0dbea475f5bdf103"
        )
    ]
)
